		...
		<div class="news">
			...
			<div class="text">
				<xsl:if test="image1/@src!=''">
					<a href="{url}"><img src="/images/news/{image1/@src}" alt="{name}" width="{image1/@w}" height="{image1/@h}" /></a>
				</xsl:if>				
	...
	<!--<div class="breadcrumbs">
		<div class="holder">
			<ul>
				...
				<xsl:if test="@article_id &gt; 0">
					<li><a href="{/page/lang_name}/articles/"><xsl:value-of select="/page/all_articles" /></a></li>
				</xsl:if>				
				<xsl:if test="count(breadcrumbs) &gt; 1">
