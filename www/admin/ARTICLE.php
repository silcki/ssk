...
$sth=$cmf->execute('select A.ARTICLE_ID,DATE_FORMAT(A.DATA,"%Y-%m-%d %H:%i"),A.NAME,A.SPECIAL_URL,A.STATUS from ARTICLE A where 1'.' '.$SORTQUERY[$_REQUEST['s']].'limit ?,?',$pagesize*($_REQUEST['p']-1),$pagesize);
