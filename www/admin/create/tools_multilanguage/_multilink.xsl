...
<tr bgcolor="#F0F0F0" class="ftr">
        <td colspan="2">
        <input type="submit" name="el{$pos}" value="Изменить" class="gbt bsave"/><xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text><xsl:if test="@type">
        <input type="image" name="e" onclick="this.form.action='EDITER.php';" src="i/xml.gif" border="0"/><xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text><xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text></xsl:if>
...
<form method="POST" action="{$parenttable/@name}.php#fl{$pos}" ENCTYPE="multipart/form-data"><xsl:attribute name="onsubmit">return true <xsl:apply-templates select="col" mode="formvalid"/>;</xsl:attribute>
        <tr bgcolor="#F0F0F0" class="ftr">
                <td colspan="2">
                <input type="submit" name="el{$pos}" value="Добавить" class="gbt badd"/><xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                <input type="submit" name="el{$pos}" value="Отменить" class="gbt bcancel"/>
                </td>
        </tr>
...
<table><tr><td><xsl:value-of select="/config/table[@name=$plbtn]/name"/>: <select name="{/config/table[@name=$plbtn]/col[@primary='y']/@name}" onchange="return chan(this.form,this.form.elements['{col[@link='y'][ref/table!=$parenttable/@name]/@name}[]'],'select {col[@link='y'][ref/table!=$parenttable/@name]/@name},{col[@link='y'][ref/table!=$parenttable/@name]/ref/visual} from {/config/table[@name=$ltbn]/@name} where {/config/table[@name=$plbtn]/col[@primary='y']/@name}=? and CMF_LANG_ID=$cmfLangId order by NAME',this.value);"><option>--</option>{$VV_<xsl:value-of select="/config/table[@name=$plbtn]/col[@primary='y']/@name"/>}</select><xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
...
@print <xsl:text disable-output-escaping="yes">&lt;&lt;&lt;</xsl:text>EOF
<tr bgcolor="#FFFFFF"><td><span class="title2"><xsl:value-of select="$parenttable/name"/></span></td><td width="100%">
<table><tr><td><xsl:value-of select="/config/table[@name=$plbtn]/name"/>: <select name="{/config/table[@name=$plbtn]/col[@primary='y']/@name}" onchange="return chan(this.form,this.form.elements['{col[@link='y'][ref/table!=$parenttable/@name]/@name}[]'],'select {col[@link='y'][ref/table!=$parenttable/@name]/@name},{col[@link='y'][ref/table!=$parenttable/@name]/ref/visual} from {/config/table[@name=$ltbn]/@name} where {/config/table[@name=$plbtn]/col[@primary='y']/@name}=? order by NAME',this.value);"><option>--</option>{$VV_<xsl:value-of select="/config/table[@name=$plbtn]/col[@primary='y']/@name"/>}</select><xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
Фильтр: <input type="text" name="q" onkeyup="return chan(this.form,this.form.elements['{col[@link='y'][ref/table!=$parenttable/@name]/@name}[]'],'select {col[@link='y'][ref/table!=$parenttable/@name]/@name},NAME from {/config/table[@name=$ltbn]/@name} where {/config/table[@name=$plbtn]/col[@primary='y']/@name}=? and NAME like ? order by NAME',{/config/table[@name=$plbtn]/col[@primary='y']/@name}.value+'\|%25'+this.value+'%25');"/></td></tr>
<tr><td><select name="{col[@link='y'][ref/table!=$parenttable/@name]/@name}[]" multiple="" style="width:100%" size="8"></select></td></tr></table></td></tr>
EOF;
	</xsl:otherwise>
        ...
        print qq{<tr><td class="tbl_t2"><span class="title2"><xsl:value-of select="$parenttable/name"/></span></td><td class="tbl_e2" width="100%">
                <table><tr><td><xsl:value-of select="/config/table[@name=$plbtn]/name"/>: <select name="{/config/table[@name=$plbtn]/col[@primary='y']/@name}" onchange="return chan(this.form,this.form.elements['{col[@link='y'][ref/table!=$parenttable/@name]/@name}[]'],'select {col[@link='y'][ref/table!=$parenttable/@name]/@name},{col[@link='y'][ref/table!=$parenttable/@name]/ref/visual} from {/config/table[@name=$ltbn]/@name} where {/config/table[@name=$plbtn]/col[@primary='y']/@name}=? order by NAME',this.value);">$VV_<xsl:value-of select="/config/table[@name=$plbtn]/col[@primary='y']/@name"/></select><xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
        Фильтр: <input type="text" name="q" onkeyup="return chan(this.form,this.form.elements['{col[@link='y'][ref/table!=$parenttable/@name]/@name}[]'],'select {col[@link='y'][ref/table!=$parenttable/@name]/@name},NAME from {/config/table[@name=$ltbn]/@name} where {/config/table[@name=$plbtn]/col[@primary='y']/@name}=? and NAME like ? order by NAME',{/config/table[@name=$plbtn]/col[@primary='y']/@name}.value+'\|%25'+this.value+'%25');"/></td></tr>
        <tr><td><select name="{col[@link='y'][ref/table!=$parenttable/@name]/@name}[]" multiple="" style="width:100%" size="8"></select></td></tr></table></td></tr>};
...
?<xsl:text disable-output-escaping="yes">&gt;</xsl:text><tr bgcolor="#FFFFFF"><td><input type="checkbox" onclick="return SelectAll(this.form,checked,'iid[]');"/></td><xsl:apply-templates select="col[@type!=11][@visuality='y' or (@link='y' and ref/table!=$parenttable/@name)]" mode="head"/><td><xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text></td></tr><xsl:text disable-output-escaping="yes">&lt;</xsl:text>?
