...
create table LEFT_BANNS (LEFT_BANNS_ID int(12) unsigned auto_increment NOT NULL,NAME varchar(255),URL varchar(255),IMAGE varchar(50),DESCRIPTION text,IMAGE1 varchar(50),STATUS int(1) unsigned,ORDERING int(12) unsigned,primary key(LEFT_BANNS_ID));
-- LEFT_BANNS_ID,NAME,URL,IMAGE,DESCRIPTION,IMAGE1,STATUS,ORDERING
---------
